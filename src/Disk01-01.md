...
進入酒吧 跟坐在後門的人對話，Option 2
inside the pub: 2nd option twice
discussion with Rinoa: 1st option, then 2nd option

inside the house: talk to Quistis, then leave
go right to the pre-Train Station screen

leave Timber: dialogue with the guards: 2nd option twice

Laguna Dream 2:
1st battle:
If Ward is in back attack mode: Kill Ward
take ladder down
walk 7 steps after dialogue
walk 5 steps after an encounter
at road crossings: 
go up
go right
go up
forced encounters:
prioritize darker Soldiers
