...
## Balamb Town
戰後視乎Diablos Boss戰情況，經Item Potion回復(待確認，前述流程中有多少Potions可用)
...
(待確認路線)Deling City: 右, 上, 下, 左就到酒店

入酒吧/酒店下層，跟侍應對話，Option 2

音樂完後找Julia。(實測音樂中無法三倍速)

上房聊天

### 調整裝備
Junction (待確認是否有long waiting，不然應該可以移到Timber小遊戲後Boss戰前)
- Laguna: (待確認應該Map去Squall)
	- GF: +Ifrit, -Quezacotl, -Shiva, -Siren
	- Auto -> Atk
	- Command: Magic, Draw, Item
	- Ability: Str+20%
