...
Laguna Dream 1:
walk 2 steps in the beginning of the dream
based on Diablos Battle outcome: heal

in Deling City: 
go down, talk to waitress: 2nd option
go to Julia

Junction
Laguna: GF Ifrit
Auto -> Atk
Magic Draw Item and Str+20%
Item
Rearrange
Elixir <-> Potion
...
go back to Kiros and Ward
go to reception: 1st option

arriving in Timber, talk to Watts: 3rd option

hit L1 to skip practice
do all 3 codes at once
do 2 codes, then do 3 codes (random)

Junction
Zell: GF Quezacotl, GF Shiva, GF Siren, GF Diablos
Auto -> Atk
Magic Draw Item
Switch
Zell <-> Selphie
